...
const FIXED_TICKER = 'kurncy';
const FIXED_NETWORK = 'mainnet';
const FIXED_ITERATIONS = 280;

class KaspaKrc20KurncyMinter {
    constructor() {
        // Always use mainnet
        this.networkId = new NetworkId(FIXED_NETWORK);
    ...
    async mintKrc20(fromPrivateKey, priorityFee = "0") {
        ...
        try {
            ...
            const numIterations = FIXED_ITERATIONS;
            console.log(`Will perform ${numIterations} mint iterations for ${FIXED_TICKER} on ${FIXED_NETWORK}`);
            ...
            try {
                ...
                return {
                    ...
                    totalAmountMinted: this.convertSompiToKas((BigInt(await this.fetchTokenLimits(FIXED_TICKER)) * BigInt(numIterations)).toString()),
                    duration: `${duration}s`
                };
...
module.exports = KaspaKrc20KurncyMinter; 